...
function createRollover(thumb) {
   ...
   thumb.over.src = thumb.src.replace(/_thumb/, "_roll");
...
function createGallery(slides) {
   ...
   closeButton.onclick = function() {
      fadeOut("galleryBox", 100, 1.5, 0);
      fadeOut("pageOverlay", 80, 1.5, 0);
      setTimeout(function() {
...
function showGallery() {
   ...
   fadeIn("galleryBox", 100, 1.5, 0);
   fadeIn("pageOverlay", 80, 1.5, 0);
