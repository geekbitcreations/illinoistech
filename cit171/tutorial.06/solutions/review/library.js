/*
   ...
   nextTo(object1, object)
      Returns a Boolean value indicating whether object1 lies
      next to object2
   ...
   scrambleIntegers(size)
      Returns an array of integers from 0 up to size-1 sorted in random 
      order with even parity observed in the sorting of the integers 
      (to ensure that the sliding blocks puzzle is solvable.)
