/*
   ...
   Tutorial 10 Additional Project Solution
...
function showContent(windowObj, word, correct) {
   content = "<html><head><title>Guessing Game Result</title>";
   content += "<link rel='stylesheet' href='guess.css' type='text/css' />";
   content += "</head><body><table><tr><td>";
   if (correct) {
      content += "<img src='correct.jpg' alt='' /> </td><td>";
      content += "Congratulations! You have successfully"
		+ " discovered the word " + word + "."
      
   } else {
      content += "<img src='incorrect.jpg' alt='' /></td><td>";
      content += "Sorry, your chances are over. The word was "
		+ word + "."
   }
...
function gameresult(word, correct) {
  resWin = window.open("","","width=350,height=150,left=250,screenX=250,top=250, screenY=250");
  nopop = (resWin == null || typeof(resWin) == "undefined") ? true : false;
  ...
  if (nopop) {
    ...
    showContent(resWin, word, correct);
  }
}
