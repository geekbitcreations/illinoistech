...
/*    The pickemGame Object  */

pickemGame = new Object();
pickemGame.account = null
pickemGame.bet = null;
pickemGame.placeBet = function() {
   this.account -= this.bet;
}
pickemGame.payout = function(odds) {
   this.account += this.bet*odds;
}


/*   Method to add a card to a hand */
pokerHand.prototype.addToHand = function(cardObj) {
