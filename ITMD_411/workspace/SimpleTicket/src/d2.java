   ...
   d2(){
    ...
    public void insert(){try {
       ...
       displayAllTickets();
            ...
            String insert ="INSERT INTO dbarnticket (ID,NAME,PHONE,TAG,DATE,PROBLEM,NOTES,STATUS) VALUES ("+(total()+1)+",'hello','33333','hello',' Wed Jan 08 12:12:05',' hello',' hello','NEW')";
