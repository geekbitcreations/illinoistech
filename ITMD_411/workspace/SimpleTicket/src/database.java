...
public class database {
 ...
 //Attempt connection to the database
             ...
             con = DriverManager.getConnection("jdbc:mysql://www.papademas.net/tickets?", "fp411", "411");
    ...
    public void addTicket(phonecallTicket ticket){
        try {
          ...
          stmt.executeUpdate(insert);
           ...
           rs = stmt.executeQuery("SELECT * FROM dbarnticket");
            total();
        } catch (Exception e) {
 ...
 */
  ...
  String p = " ";
   try {
            ...
            rs = stmt.executeQuery             
         ("select * from dbarnticket ORDER BY NAME");
      p = loopDBInfo(rs);
  ...
  return p;
    ...
    public void addEmployee(employee emp){
     try {
          ...
          empstmt.executeUpdate(insert);
           ...
           emprs = stmt.executeQuery("SELECT * FROM dbarnticket");
            total();
        } catch (Exception e) {
    ...
    public void delEmployee(String person){
        ...
        try {
          String delete ="DELETE FROM dbarnticket WHERE NAME='" + person+"'"; 
  ...
  try{
       ...
       switch(numstatus){
        ...
        String update = "UPDATE dbarnticket SET STATUS='" +  status + "' WHERE ID=" + ID;
